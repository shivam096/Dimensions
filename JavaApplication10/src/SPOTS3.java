 ...
 * @author Shivam
 */
public class SPOTS3 extends javax.swing.JFrame {
int count=0;
    /**
     * Creates new form SPOTS3
     */
    public SPOTS3() {
        initComponents();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try
        {
            FileWriter wr = new FileWriter("Slot3.txt",true);
            BufferedWriter buff= new BufferedWriter(wr);
            PrintWriter rr =new PrintWriter(buff);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SPOTS3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
